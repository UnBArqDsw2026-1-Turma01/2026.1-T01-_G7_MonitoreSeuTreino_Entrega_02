...
* **Léxico:** Os termos técnicos adotados nos atores e nas etapas (como *Rotina* L03, *Exercício* L04, *Sessão* L06 e *Parâmetros Planejados* L05) estão ancorados rigorosamente na documentação do Léxico.
...
| 23/04/2026 |    1.2     | Integração do UC02 de criação de rotina e revisão geral | Eduardo Waski  |      -      |
