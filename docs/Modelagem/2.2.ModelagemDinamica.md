...
#### 4.1.3. Justificativas Arquiteturais
...
### 4.3. Criação de Rotina com Exercícios
...
| 23/04/2026 |    1.9     | Adicionado diagrama de estados                                                   | Mateus Santos Negrini                |      -      |
| 24/04/2026 |    1.10    | Adição do Diagrama de Estados da Sessão de Treino e o detalhamento desse diagrama| João Nascimento                      |      -      |
| 24/04/2026 |    2.0     | Correção do diagrama de estados: Conta de Usuário                                | José Victor Gabriel Menezes da Costa |      -      |
