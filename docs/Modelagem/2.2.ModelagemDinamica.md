...
- **Selecionar um exercício** (*Selecionando*), visualizando seus detalhes;
- **Continuar buscando mais exercícios**, retornando ao próprio estado;
- Ou optar por **criar um novo exercício**, transitando para o estado *Criando* sem perder o contexto da rotina.
...
*Diagrama de Estados - Sessão de treino. Autor: [João Nascimento](https://github.com/JMPNascimento).*
