...
![Diagrama de Banco de Dados](../anexos/img/ModelagemEstatica/)

**Figura 10: Diagrama de Banco de dados - Visão geral das entidades e relacionamentos. Autor: Lucas Antunes, Giovanni Dornelas e André Meyer.**
...
INSERIR DIAGRAMA AQUI
![Diagrama de Banco de Dados Identidade](../anexos/img/ModelagemEstatica/diagrama-de-banco-de-dados-.png)

**Figura 12: Diagrama de Banco de dados de catálogo e planejamento - Visão das entidades de identidade do banco. Autor:.**
...
INSERIR DIAGRAMA AQUI
**Figura 13: Diagrama de Banco de dados de execução e métricas - Visão das entidades de identidade do banco. Autor:.**
