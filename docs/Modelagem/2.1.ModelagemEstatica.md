...
*Diagrama de Componentes. Autor: [João Nascimento](https://github.com/JMPNascimento).*
...
- **Backend:** Centraliza a regra de negócio do sistema em serviços especializados (Serviço de Autenticação, Serviço de Perfil, Serviço de Treinos e Serviço de Monitoramento), além de um Serviço de E-mail responsável pela mensageria, o qual atua de forma interligada com os demais.
...
| 24/04/2026 |    1.5     | Adição do Diagrama de Componentes e o detalhamento desse diagrama    | João NAscimento |      -      |
| 24/04/2026 |    1.6     | Adicionando uma nova versão do diagrama de componentes    | José Victor Gabriel & Eduardo Silva Waski |      -      |
